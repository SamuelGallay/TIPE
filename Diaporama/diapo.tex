...
étudiant(E, pierre) ?
  ...
  \begin{exampleblock}{Signification :}
    \mintinline{prolog}{apprend(E,M)} $et$ \mintinline{prolog}{enseigne(P,M)} $implique$ \mintinline{prolog}{étudiant(E,P)}
  \end{exampleblock}
...
zebra(H, W, Z) ?
  ...
  \begin{exampleblock}{Signification des variables :}
    \mintinline{prolog}{[[norwegian, dog, water], [japanese, zebra milk]]} est un exemple de liste \mintinline{prolog}{H}.
  \end{exampleblock}
